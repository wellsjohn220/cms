<script type="text/javascript">
    function delete_post(uid)
    {
        ...
        {
            window.location.href = 'posts.php?delete=' + uid;           
        }
    }
</script>
...
<div id="bulkOptionContainer" class="col-xs-2" style="padding:0;">
<select class="form-control" name="bulk_options" id="">
            <option value="">Select Options</option>
            <option value="published">Publish</option>
            <option value="draft">Draft</option>
            <option value="delete">Delete</option>   <option value="clone">Clone</option>
        </select>
</div>
<div class="col-xs-4">
    <input type="submit" name="submit" class="btn btn-success" calue="Apply">
...
<?php
    ...
    while($row = mysqli_fetch_assoc($select_posts)){
       ...
       echo "<td><img src='../images/{$post_image}' style='width:70px;height:20px;'></td>";   echo "<td>{$post_tags}</td>";  
       ...
       ?>
    <td><a class='btn btn-danger btn-sm' href="javascript: delete_post(<?php echo $post_id; ?>)"> Delete</a></td>
    <?php 
